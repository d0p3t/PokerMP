...
namespace PokerMP.Algorithms
{
    internal class MonteCarlo : IMonteCarlo
    {
        ...
        {
            IList<Card> deck = GetDeck(playerFirstCard, playerSecondCard, communityCards);
            ...
            for (int i = 0; i < SimulationsCount; i++)
            {
                ...
                int currentCardStrengthResult = Helpers.Helpers.CompareCards(myHand, opponentHand);
